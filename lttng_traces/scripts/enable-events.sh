#
# Scripts to enable events for lttng kernel tracing

echo `lttng enable-event lttng_statedump_process_state,lttng_statedump_file_descriptor,\
lttng_statedump_network_interface -k`

echo "lttng_statedump_process_state,lttng_statedump_file_descriptor, lttng_statedump_network_interface has been enabled"

# Available kernel envents:
